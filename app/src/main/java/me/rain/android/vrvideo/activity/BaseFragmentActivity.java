...
public class BaseFragmentActivity extends FragmentActivity {
    ...
    private BaseActivity.PmListener mPmListener;
    private ProgressDialog dialog;
    private String dialog_message;
    public void checkPermission(BaseActivity.PmListener listener, String message, String... permissions){
        ...
        if (needRequest){
            ...
            ActivityCompat.requestPermissions(this, permissionArray, BaseActivity.REQUEST_PERMISSION);
        }else {
            if (mPmListener != null){
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == BaseActivity.REQUEST_PERMISSION) {
